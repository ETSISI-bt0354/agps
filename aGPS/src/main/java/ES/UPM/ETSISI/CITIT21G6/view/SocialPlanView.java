...
public interface SocialPlanView
{
    ...
    String createSocialPlanHelp(boolean justArgs);
    String deleteSocialPlanHelp(boolean justArgs);
    String addActivityHelp(boolean justArgs);
    String listSocialPlansHelp(boolean justArgs);
    String listSubscribedSocialPlansHelp();
    String unjoinSocialPlanHelp(boolean justArgs);
    String joinSocialPlanHelp(boolean justArgs);
    String checkPlanCostHelp(boolean justArgs);
    String setScoreHelp(boolean justArgs);
    String showActivitiesHelp(boolean justArgs);
    String showParticipantsHelp(boolean justArgs);
    String showDurationHelp(boolean justArgs);
    String setSocialPlanCapacityHelp(boolean justArgs);
}
